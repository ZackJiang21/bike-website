      ...
      return {
        ...
        fitMovement: [
          ...
          },
          {
            ...
            left: this.getFittingValObj(distance, 'Knee_Lateral_Travel', 'left'),
            right: this.getFittingValObj(distance, 'Knee_Lateral_Travel', 'right'),
            rangeStart: 5,
            rangeEnd: 36,
            unit: 'mm',
          ...
          },
          {
            ...
            left: this.getFittingValObj(distance, 'Hip_Vertical_Travel', 'left'),
            right: this.getFittingValObj(distance, 'Hip_Vertical_Travel', 'right'),
            unit: 'mm',
            isWarn: false,
          },
          {
            ...
            left: this.getFittingValObj(distance, 'Hip_Lateral_Travel', 'left'),
            right: this.getFittingValObj(distance, 'Hip_Lateral_Travel', 'right'),
            rangeStart: 5,
            rangeEnd: 20,
            unit: 'mm',
            isWarn: this.isWarning(distance, 'Hip_Lateral_Travel'),
          },
        ],
      };
    },
